      ...
      <Grid container component="main" sx={{ height: '40vh' }}>
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
          ...
          >
            ...
            <div className='dev2'><h5 className='dev6'>Get ideas, inspirations & offers in your inbox</h5></div>
            <div className='dev3'><h4 className='dev7'>BE THE FIRST TO KNOW</h4></div>
